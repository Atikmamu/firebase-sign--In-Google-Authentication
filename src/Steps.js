 ...
 * 5. get firebase config and [you should no] add the config in your project
 *    [do not save or share your config]
 * 6. enable sign in method that you want to use: 
 *    Build > Authentication > Get Started > click on Google > Enable > set the email address > save 
